...
pdata["ref_dist"] = pdata["ref_dist"].groupby('video_name').apply(lambda group: group.interpolate(method='index'))
pdata["ref_dist"] = pdata["ref_dist"].groupby('video_name').apply(lambda group: group.interpolate(method='bfill'))
pdata["ref_dist"] = pdata["ref_dist"].groupby('video_name').apply(lambda group: group.interpolate(method='pad'))
